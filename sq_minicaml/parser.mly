...
expr:
 ...
 | IF expr THEN expr ELSE expr { Ml_if(fst $2, fst $4, fst $6), StrSet.union (StrSet.union (snd $2) (snd $4)) (snd $6) }
 ...
 | LET REC IDENT  EQUAL expr IN expr { Ml_letrec($3, failwith "let rec type expected", fst $5, fst $7) ,  StrSet.union (snd $5) (StrSet.remove $3 (snd $7)) }
...
pattern:
 | LEFT_PAREN IDENT COLON typ RIGHT_PAREN{ Ml_pattern_var ($1,failwith "pattern variable: type expected") , StrSet.singleton $1}
 ...
 | LEFT_PAREN LEFT_BRACKET RIGHT_BRACKET COLON typ TLIST RIGHT_PAREN { Ml_pattern_nil (failwith "pattern []: type expected") ,  StrSet.empty }
 | pattern CONS pattern { Ml_pattern_cons(fst $1, fst $3), StrSet.union (snd $1)(snd $3) }

pattern_expr_list:
 | pattern ARROW expr pattern_expr_list_next { (fst $1, fst $3) :: fst $4 , StrSet.union (snd $1) (StrSet.union (snd $3) (snd $4))}

pattern_expr_list_next:
 | ALTERNATIVE pattern ARROW expr pattern_expr_list_next { (fst $2, fst $4) :: fst $5, StrSet.union  (snd $2) (StrSet.union (snd $4) (snd $5)) }
